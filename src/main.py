...
from .modes import directions_map, trajectories_compare, trajectories_map
...
def main() -> None:
    ...
    trajectories_compare.fill_parser(modes.add_parser("traj_comp")).set_defaults(module=trajectories_compare)
